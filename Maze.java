    ...
    public static void main(String[] args)
    {
        ...
        while(!done && charIndex < solutionLength)
        {
            ...
            switch(direction)
            {
                ...
                default:
                    System.out.println("where youre going"); // Invalid direction.
            }
                ...
                || currentRow >= grid.length || currentCol >= grid[currentRow].length)
            {
                ...
                System.out.println("fall into the chasm of doom"); // Out of bounds.
            }
            else
            {
                ...
                else if(grid[currentRow][currentCol] == WALL)
                {
                    ...
                    System.out.println(" stumble blindly into a solid concrete wall"); // Hit wall.
                }
